function wrapper() {
  ...
  var width = 480;
  var height = 385;
  var button = "<div style=\"display: inline-block; position: relative; top: -" + (height - 14) + "px; left: 2px; background: #666; width: 20px; height: 20px; font-size: 14px; line-height: 16px; text-align: center; cursor: pointer;\"><b style=\"color: #fff;\">x</b></div>";
  ...
  width = 480;
  height = 385;
  button = "<div style=\"display: inline-block; position: relative; top: -" + (height - 14) + "px; left: 2px; background: #666; width: 20px; height: 20px; font-size: 14px; line-height: 16px; text-align: center; cursor: pointer\"><b style=\"color: #fff;\">x</b></div>";
  ...
  for (var i = 0; i < vimeo_links.length; i++) {
    ...
    link.style.paddingLeft = "19px";
    link.style.backgroundRepeat = "no-repeat";
    link.style.backgroundImage = "url(http://favicon.yandex.net/favicon/vimeo.com)";
          ...
          if (this.name == "") {
            ...
            for (var link in arr) {
              ...
              link.addEventListener("click", function(e) {
                ...
                document.$lp.$t("div", pDiv)[0].style.top = "-" + (h - 14) + "px";
                //resize movie
                var elem = document.$lp.$t("iframe", pDiv)[0];
                elem.width = w;
                elem.height = h;
                e.preventDefault();
                return false;
